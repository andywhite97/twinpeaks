...
export class ProductCard {
  ...
  addToCart(): void { if (this.product.stock_status === 'out_of_stock') return; this.cartService.add(this.product); this.addedToCart = true; window.setTimeout(() => this.addedToCart = false, 1800); }
